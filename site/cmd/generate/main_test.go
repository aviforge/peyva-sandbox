...
func TestRunGeneratesChapterZeroPage(t *testing.T) {
	...
	for _, want := range []string{"What Are We Building?", "1. Why",
		"2. Concepts", "3. Build It", "Mark chapter as complete", "Build the Vault", "Inside One Computer", "Zero-shot prompting", "Documented in The Prompt Report"} {
